...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Header, HeroComponent, AboutMeComponent, SectionTransitionComponent, SkillsComponent, PortfolioComponent, ReferencesComponent, SayHiComponent],
